...
void printHeader(FILE *file) {
    fprintf(file, "From MParser.lib Require Import ExplicitName.\n");
    fprintf(file, "From MParser.lib Require Import Lang.\n");
...
int main(int argc, char **argv) {
    ...
    char inputFileName[1024] = "../theorems.json", outputFileName[1024] = "../lib/TestTheorems.v";
    if (argc >= 2) {
